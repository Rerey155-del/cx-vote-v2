  ...
  <x-admin-layout title="Voters">
    <div class=" mx-auto bg-white p-6 rounded-xl shadow-md">
      ...
      <div class="flex space-x-4 border-b mb-6">
        <button class="tab-button text-blue-600 border-b-2 border-blue-600 pb-2" onclick="openTab(event, 'aktif')">Sudah Memilih</button>
        <button class="tab-button text-gray-600 hover:text-blue-600 pb-2" onclick="openTab(event, 'luar_biasa')">Belum Memilih</button>
      </div>
